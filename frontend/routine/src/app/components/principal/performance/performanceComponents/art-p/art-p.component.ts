...
@Component({
  ...
  templateUrl: './art-p.component.html',
  styleUrl: './art-p.component.css'
})
export class ArtPComponent implements OnInit {
  ...
  search() {
    if (this.selectedsubcategory == null || this.selectedTime == null) {
      ...
      let data = new TrippleAttrNumericDao(Constants.art, this.selectedsubcategory, this.selectedTime);
